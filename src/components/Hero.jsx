...
function Hero() {
  return (
    <div className="relative text-pink-800 w-full">
      <div className="absolute inset-0 bg-cover bg-center" style={{backgroundImage: 'url(https://i.pinimg.com/736x/56/f0/bb/56f0bb78f8a3bcde1f27fb1525de3fc8.jpg)', opacity: '0.5'}}></div>
